...
<template>
  <DialogPortal>
    <DialogOverlay
      class="fixed inset-0 z-50 bg-primary/30 backdrop-blur-[1px] dark:bg-black/55 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0"
    />
    <DialogContent
      v-bind="forwarded"
      :class="
