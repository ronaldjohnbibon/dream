        ...
        <div class="flex items-center gap-1">
            ...
            <DropdownMenu v-if="isCustomer && user">
                <DropdownMenuTrigger as-child>
                    <Button variant="ghost" size="icon" aria-label="Account menu"><CircleUserRound class="size-5" /></Button>
                </DropdownMenuTrigger>
                <DropdownMenuContent align="end" class="min-w-56"><UserMenuContent :user="user" /></DropdownMenuContent>
            </DropdownMenu>
        </div>
    </header>
</template>
