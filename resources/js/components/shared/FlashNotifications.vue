...
<template>
    <div class="fixed right-4 top-4 z-50 w-full max-w-sm space-y-3">
        ...
        >
            ...
            <button type="button" class="font-semibold" aria-label="Dismiss success notification" @click="dismissedSuccess = successMessage">&times;</button>
        </div>
        ...
        >
            ...
            <button type="button" class="font-semibold" aria-label="Dismiss error notification" @click="dismissedErrors = errorKey">&times;</button>
        </div>
    </div>
</template>
