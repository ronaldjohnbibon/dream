...
const submit = () => form.put(route('password.update'), {
    preserveScroll: true,
            ...
            <Card>
                ...
                <CardContent>
                    <form class="space-y-6" @submit.prevent="submit">
                        <FormField id="current_password" label="Current password" :error="form.errors.current_password" required>
                        ...
                        <FormField id="password_confirmation" label="Confirm password" :error="form.errors.password_confirmation" required>
