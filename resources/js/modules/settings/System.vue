            ...
            <form class="space-y-6" @submit.prevent="submit">
                ...
                <Card>
                    ...
                    <CardContent class="grid gap-5 sm:grid-cols-2">
                        ...
                        <FormField id="completed-order-points" label="Points per completed pautang" :error="form.errors.completed_order_points" required><Input id="completed-order-points" v-model.number="form.completed_order_points" type="number" min="0" required /></FormField>
