    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="mx-auto w-full max-w-2xl p-4 md:p-6">
            <div class="mb-4 flex items-center justify-between gap-4">
                ...
                <Button as-child><Link :href="route('users.edit', { user: user.id })">Edit administrator</Link></Button>
            </div>
            ...
            <Card>
                ...
                <CardContent class="grid gap-5 text-sm sm:grid-cols-2">
                    ...
                    <div><p class="text-muted-foreground">Account type</p><p class="mt-1 font-medium">Administrator</p></div>
