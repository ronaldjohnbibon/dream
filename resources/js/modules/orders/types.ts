...
export interface Order {
  id: number
  order_number: string
  customer: { id: number; name: string; email: string | null; mobile_number: string | null }
  rice_product: { id: number; name: string; brand: string; sack_size: string }
  quantity: number
  unit_price: string
  subtotal: string
  points_used: number
...
export interface OrderFilters {
  search: string
  delivery_status: 'all' | DeliveryStatus
